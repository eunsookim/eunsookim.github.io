...
async function getSeries(slug: string): Promise<(Series & { category: Category }) | null> {
  ...
  return data as (Series & { category: Category }) | null;
}
...
export default async function SeriesPage({ params }: SeriesPageProps) {
  ...
  const categoryName = lang === "en" ? (category.name_en ?? category.name) : category.name;
